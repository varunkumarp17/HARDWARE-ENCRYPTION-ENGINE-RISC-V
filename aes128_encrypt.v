module aes128_encrypt (
    ...
    always @(*) begin
        ...
        for(round=1;round<10;round=round+1) begin
            for(i=0;i<16;i=i+1)
                state[127-8*i -:8]=sbox[state[127-8*i -:8]];
            ...
            for(i=0;i<4;i=i+1) begin
                ...
                state[127-32*i -:8]=xtime(a0)^xtime(a1)^a1^a2^a3;
                state[119-32*i -:8]=a0^xtime(a1)^xtime(a2)^a2^a3;
                state[111-32*i -:8]=a0^a1^xtime(a2)^xtime(a3)^a3;
                state[103-32*i -:8]=xtime(a0)^a0^a1^a2^xtime(a3);
            end
